...
import com.moirai.alloc.auth.client.AllocInternalPasswordResetClient;
...
public class AuthService {
    ...
    private final AllocInternalPasswordResetClient allocPasswordResetClient;
    ...
    public void confirmPasswordReset(PasswordResetConfirmRequest request) {
        ...
        // alloc 원본 업데이트 (internal 호출)
        allocPasswordResetClient.resetPassword(email, newPw);
